...
# Samples
curl -X GET -H "X-Token: 421cbd6a-4171-4001-9650-bfdb2c877c47" "https://ega-archive.org/submission-api/v1/samples?status=SUBMITTED&skip=0&limit=0" > samples.json
